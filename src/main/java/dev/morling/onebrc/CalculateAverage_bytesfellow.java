...
public class CalculateAverage_bytesfellow {
    ...
    private static final int availableCpu = System.getenv("CPU_CORES_1BRC") != null ? Integer.parseInt(System.getenv("CORES_1BRC")) : Runtime.getRuntime().availableProcessors();
